...
@pytest.mark.parametrize("level_name,message,elapsed_seconds", [
...
@pytest.mark.parametrize("level_no,expected_stream", [
    (10, "stdout"),  # DEBUG
    (20, "stdout"),  # INFO
...
@pytest.mark.parametrize("is_cloud,expected_sink", [
    (True, "gcp_sink"),
    (False, "local_sink"),
])
